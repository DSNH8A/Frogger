...
#objektumok adatai
x = (WIDTH * 0.45) 
# pálya határai nehogy a Player kimenjen a felületrõl
...
while run:
    ...
    # események ellenõrzése 

    for event in pygame.event.get():

        current_time = pygame.time.get_ticks()
        #score jelzõ 0-ra állítása
        Score = (y - 855) * -1
        current_time = y
        #score betûtípis beállítása és kiírása
